...
{
    /// <inheritdoc />
    public partial class AgregaSolicitudesCredito : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 0, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1000m, null },
                    { 2, 2, 1, new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 500m, null }
                });
